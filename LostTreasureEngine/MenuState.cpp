	...
	m_pCurrentGame(NULL)
{
	...
	//m_pBackgroundImg = *loadBMP("background.bmp");
	//m_pTitleImg = *loadBMP("MenuTitle.bmp");
	//m_pItemBckgndNormal = *loadBMP("MenuItems.bmp");
	//m_pItemBckgndSelected = *loadBMP("MenuItems.bmp");
